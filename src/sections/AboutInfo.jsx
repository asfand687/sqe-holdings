  ...
  return (
    <div className="bg-[#041330] text-white">
      <section className="about-info-bg h-[600px]">
        <article className="w-full max-w-5xl mx-auto flex items-center h-full flex-row-reverse">
          <div className="text-right space-y-8">
            <h2 className="text-6xl font-semibold">SQE is a quantum <br />
              secure platform</h2>
      ...
      <article className="w-full max-w-7xl mx-auto flex items-center">
        <h2 className="text-6xl max-w-xs leading-tight font-semibold">A platform for all</h2>
        <div className="flex-1 text-lg max-w-">
      ...
      <section className="py-10 flex justify-center space-x-12 text-white">
        <article className="w-[382px] h-[480px] rounded-3xl p-8 py-10 bg-[#375284] space-y-4 custom-shadow-sm">
          <h2 className="font-semibold max-w-[100px] text-5xl leading-tight">Our Network</h2>
          <p className="text-xl max-w-[16rem]">SQE was designed to be hyper efficient, ultra secure and low cost.</p>
        </article>
        <article className="w-[382px] h-[480px] rounded-3xl p-8 py-10 bg-[#375284] space-y-4 custom-shadow-sm">
